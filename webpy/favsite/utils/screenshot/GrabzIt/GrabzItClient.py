...
class GrabzItClient:
	...
	def GetResult(self, id):
		result = cStringIO.StringIO(urllib.urlopen(self.WebServicesBaseURL + "getfile.ashx?id=" + id).read()).getvalue()
	...
	def GetCookies(self, domain):
		...
		dom = minidom.parseString(urllib.urlopen(self.WebServicesBaseURL + "getcookies.ashx?" + encoded_qs).read())
	...
	def SetCookie(self, name, domain, value = "", path = "/", httponly = False, expires = ""):
		...
		return self.IsSuccessful(urllib.urlopen(self.WebServicesBaseURL + "setcookie.ashx?" + encoded_qs).read())		
	...
	def DeleteWaterMark(self, identifier):
		...
		return self.IsSuccessful(urllib.urlopen(self.WebServicesBaseURL + "deletewatermark.ashx?" + encoded_qs).read());	
	...
	def GetWaterMarks(self, identifier = ""):
		...
		dom = minidom.parseString(urllib.urlopen(self.WebServicesBaseURL + "getwatermarks.ashx?" + encoded_qs).read())
